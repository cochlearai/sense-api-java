...
public class AudioSessionApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> The session was created successfully  </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The parameter is missing or not formatted properly  </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Authentication failed. For instance, API key is missing or invalid  </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Unexpected server error. If the error persists, you can contact support@cochl.ai to fix the problem.  </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @param sessionId Session id represents a unique identifier for an audio session  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> The session successfully deleted  </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Resources don&#39;t exist or have been deleted  </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Unexpected server error. If the error persists, you can contact support@cochl.ai to fix the problem.  </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @param sessionId Session id represents a unique identifier for an audio session  (required)
     * @param offset How many existing elements to skip before returning the first result control how many results to receive  (optional, default to 0)
     * @param count Limit the length of the returned results array to limit the size of the returned payload  (optional, default to 1024)
     * @param nextToken The next token can be used from a previous page result. It allows to iterating through all the next elements of a collection. If next_token is set, offset and limit will be ignored  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 400 </td><td> Parameter is missing or not formatted properly  </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Resources don’t exist or have been deleted  </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Unexpected server error. If the error persists, you can contact support@cochl.ai to fix the problem.  </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> The session has been updated successfully  </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The parameter is missing or not formatted properly  </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Resources don’t exist or have been deleted  </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Unexpected server error. If the error persists, you can contact support@cochl.ai to fix the problem.  </td><td>  -  </td></tr>
     </table>
     ...
     * @param sessionId Session id represents a unique identifier for an audio session  (required)
     * @param chunkSequence Chunk represents the chunk number. This is needed to be a counter starting from 0 and growing by one on each request  (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The chunk successfully uploaded  </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The parameter is missing or not formatted properly  </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> The session is not writable anymore  </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Resources don’t exist or have been deleted  </td><td>  -  </td></tr>
        <tr><td> 409 </td><td> The chunk sequence is invalid  </td><td>  -  </td></tr>
