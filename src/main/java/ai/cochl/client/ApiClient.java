...
import ai.cochl.client.auth.Authentication;
import ai.cochl.client.auth.HttpBasicAuth;
import ai.cochl.client.auth.HttpBearerAuth;
import ai.cochl.client.auth.ApiKeyAuth;

public class ApiClient {

    private String basePath = "https://api.cochl.ai/sense/api/v0";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v0.0.1-SNAPSHOT/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.cochl.ai/sense/api/v0
