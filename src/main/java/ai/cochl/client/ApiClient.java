...
public class ApiClient {
    ...
    private String basePath = "https://api.cochl.ai/sense/api/v1";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v1.4.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.cochl.ai/sense/api/v1
